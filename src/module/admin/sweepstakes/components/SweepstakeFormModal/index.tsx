...
import { createSweepstake } from '@core/services/sweepstakes'
import { getPresets } from '@core/services/presets'
import useAction from '@core/hooks/useAction'

import * as S from './styles'

import type { SweepstakeFormModalProps, SweepstakeFormData } from './types'
import type { PresetResponse } from '@core/services/presets/types'
